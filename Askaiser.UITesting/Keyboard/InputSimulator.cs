namespace Askaiser.UITesting.Keyboard
{
    ...
    internal class InputSimulator : IInputSimulator
    {
        ...
        {
            this._keyboardSimulator = new KeyboardSimulator(this);
            this._mouseSimulator = new MouseSimulator(this);
        ...
        {
            get { return this._keyboardSimulator; }
        }
        ...
        {
            get { return this._mouseSimulator; }
        }
        ...
        {
            get { return this._inputDeviceState; }
        }
    }
}